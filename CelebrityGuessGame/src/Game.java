...
//    						newCelebNode.setLeftChild(new Node(newCelebNode.getId(), null, null, null, newCeleb).getId());
...
//    						newCelebNode.setRightChild(new Node(newCelebNode.getId(), null, null, null, newCeleb).getId());
    					...
    					System.out.println(gameTree.tree);
//    					String celebString = celeb.toString();
//    					System.out.println(celebString);
//    					System.out.println(celebString.length());
    				}
    			} else {
    				s.close();
    			}
